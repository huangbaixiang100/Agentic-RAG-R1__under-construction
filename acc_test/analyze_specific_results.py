...
def analyze_file(file_path: str) -> Dict:
    ...
    try:
        ...
        result = {
            ...
            'dataset': 'CMB' if 'cmb' in file_path.lower() else 'MedQA',
            'model': 'Qwen3_8b2' if '8b2' in file_path else ('Qwen3_8b' if '8b' in file_path else 'Qwen3_1.7b'),
            'accuracy': accuracy,
...
def main():
    ...
    # 保存结果
    output_file = "/home/xiaobei/Agentic-RAG-R1__under-construction/acc_test/specific_results_analysis.csv"
    df.to_csv(output_file, index=False, encoding='utf-8')
    
    # 保存Excel格式
    excel_file = "/home/xiaobei/Agentic-RAG-R1__under-construction/acc_test/specific_results_analysis.xlsx"
