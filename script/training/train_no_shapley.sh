#!/bin/bash
# Token级奖励分配训练脚本 - 无Shapley版本
# 支持细粒度奖励分配，结合过程奖励和结果奖励

# 使用绝对路径激活conda环境
export PATH="/home/xiaobei/miniconda3/bin:$PATH"
eval "$(/home/xiaobei/miniconda3/bin/conda shell.bash hook)"
...
# 启用Token级奖励分配训练！
echo "=========================================="
echo "🎯 启动Token级奖励分配医疗对话训练 (无Shapley)"
echo "=========================================="
echo "✓ 启用Token级奖励分配"
echo "✓ 结合过程奖励和结果奖励"
echo "✗ 禁用Shapley值加权信息增益"
